...
All Scaffold-Hbar-UI component styles rely on the default [tailwindcss theme variables](https://tailwindcss.com/docs/theme#what-are-theme-variables) defined in [styles.css](https://github.com/buidler-labs/scaffold-hbar-ui/blob/main/packages/components/src/styles.css).
...
For example, if you want to change the text color of the Address component, you can check the [source code](https://github.com/buidler-labs/scaffold-hbar-ui/blob/ea325159a4f733d79c99c7805fb50e4945e96873/packages/components/src/Address/Address.tsx#L82) and see that the `Address` component has the class `text-sui-primary-content`, which uses the `--color-sui-primary-content` variable for the text color. Let's redefine it:
